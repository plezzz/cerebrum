 ...
 */
final class Version20220516114824 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
     ...
     //   $this->addSql('ALTER TABLE temperature_list CHANGE edited_at edited_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
    ...
    public function down(Schema $schema): void
    {
      ...
      //  $this->addSql('ALTER TABLE temperature_list CHANGE edited_at edited_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
}
