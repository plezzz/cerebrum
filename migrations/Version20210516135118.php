 ...
 */
final class Version20210516135118 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', CHANGE created_by_id created_by_id INT NOT NULL, CHANGE edited_by_id edited_by_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP roles, CHANGE created_by_id created_by_id INT DEFAULT NULL, CHANGE edited_by_id edited_by_id INT DEFAULT NULL');
    }
}
